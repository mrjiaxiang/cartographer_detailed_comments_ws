...
struct NodeOptions {
  ...
  double lookup_transform_timeout_sec;// look up tf time
  double submap_publish_period_sec; // submap publish
  double pose_publish_period_sec; // pose publish
  double trajectory_publish_period_sec; // trajectory publish
